...
<script>
	...
	export default{
		...
		asyncData (params) {
			...
			var datas = {hot_num:5,product_type:id,num:15,page:1,}
		...
		methods: {
			loadMore() {
				...
				if(this.rqClass != ''){
					var datas = {order_name:'is_hot',order_type:'desc',hot_num:5,product_type:id,num:15,page:page}
				}else if(this.salerClass != ''){
					var datas = {order_name:'sales',order_type:'desc',hot_num:5,product_type:id,num:15,page:page}
				}else if(this.switchClass != '' && this.switchClass == 'active1'){
					var datas = {order_price:'desc',hot_num:5,product_type:id,num:15,page:page}
				}else if(this.switchClass != '' && this.switchClass == 'active2'){
					var datas = {order_price:'asc',hot_num:5,product_type:id,num:15,page:page}
				}else{
					var datas = {hot_num:5,product_type:id,num:15,page:page}
				}
			...
			popularity(){
				var id = this.id;
				var datas = {order_name:'is_hot',order_type:'desc',hot_num:5,product_type:id,num:15,page:1}
				this.rqClass = '1';
				this.salerClass = '';
				this.switchClass = '';
				this.page = 1;	//重置页面数
			...
			saler(){
				var id = this.id;
				var datas = {order_name:'sales',order_type:'desc',hot_num:5,product_type:id,num:15,page:1}
				this.rqClass = '';
				this.salerClass = '1';
				this.switchClass = '';
				this.page = 1;	//重置页面数
			...
			price(){
				...
				if(this.switchClass == 'active1'){
					...
					var datas = {order_price:'asc',hot_num:5,product_type:id,num:15,page:1}
					this.proction(datas)
				}else{
					this.switchClass = 'active1'
					var datas = {order_price:'desc',hot_num:5,product_type:id,num:15,page:1}
					this.proction(datas)
				}
				this.page = 1;	//重置页面数
			},
